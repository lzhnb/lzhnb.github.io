(function (global, factory) {
    ...
    class SplatBuffer {
        ...
        getCenter(index, outCenter = new THREE__namespace.Vector3(), transform) {
            let bucket = [0, 0, 0];
        ...
        getScaleAndRotation = function() {
            ...
            return function(index, outScale = new THREE__namespace.Vector3(), outRotation = new THREE__namespace.Quaternion(), transform) {
        ...
        getColor(index, outColor = new THREE__namespace.Vector4(), transform) {
        ...
        swapVertices(indexA, indexB) {
            ...
            const getScale = (index, outScale = new THREE__namespace.Vector3()) => {
                const scaleBase = index * SplatBuffer.ScaleComponentCount;
                outScale.set(fbf(this.scaleArray[scaleBase]), fbf(this.scaleArray[scaleBase + 1]), fbf(this.scaleArray[scaleBase + 2]));
                return outScale;
            };
            ...
            const getRotation = (index, outRotation = new THREE__namespace.Quaternion()) => {
                const rotationBase = index * SplatBuffer.RotationComponentCount;
                outRotation.set(fbf(this.rotationArray[rotationBase + 1]), fbf(this.rotationArray[rotationBase + 2]),
                                fbf(this.rotationArray[rotationBase + 3]), fbf(this.rotationArray[rotationBase]));
                return outRotation;
                ...
                for (let i = 0; i < bucket.splats.length; i++) {
                    ...
                    if (this.compressionLevel === 0) {
                        ...
                        if (validSplats['scale_0'][row] !== undefined) {
                            const quat = new THREE__namespace.Quaternion(validSplats['rot_1'][row], validSplats['rot_2'][row],
    ...
    class RenderableViewer extends THREE__namespace.Group {
    ...
    exports.RenderableViewer = RenderableViewer;
    exports.SplatBuffer = SplatBuffer;
    exports.SplatCompressor = SplatCompressor;
